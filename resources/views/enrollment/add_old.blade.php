          ...
          <div class="row g-0" id="guidingContent">
            ...
            <div class="col-md-6 col-lg-3 border-end">
              <div class="p-3 h-100">
                ...
                <div id="passedCoursesList" class="guide-list" style="max-height: 200px; overflow-y: auto;"></div>
              </div>
            </div>
            <!-- Failed/Incomplete -->
            <div class="col-md-6 col-lg-3 border-end">
              <div class="p-3 h-100 bg-light">
                ...
                <div id="failedCoursesList" class="guide-list" style="max-height: 200px; overflow-y: auto;"></div>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3 border-end">
              <div class="p-3 h-100">
                ...
                <div id="studyPlanCoursesList" class="guide-list" style="max-height: 200px; overflow-y: auto;"></div>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3">
              <div class="p-3 h-100 bg-light">
                ...
                <div id="missingCoursesList" class="guide-list" style="max-height: 200px; overflow-y: auto;"></div>
              </div>
            </div>
          </div>
        </div>
...
const GuidingModule = {
  ...
  display(data) {
    ...
    // Update semester number in header
    ...
    // Add status badges to study plan courses
...
const EnrollmentApp = {
  ...
  setupGlobalVariables() {
      window.routes = window.routes || {
        ...
        courseSchedules: '{{ route("available_courses.schedules.all", ":id") }}',
  ...
  handleTermChange() {
    ...
    if (EnrollmentState.currentStudentId) {
      ...
      // Only show guide card when a term is selected
      if (EnrollmentState.currentTermId) {
