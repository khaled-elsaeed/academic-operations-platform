...
class UpdateAvailableCourseRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'schedule_details.*.group_numbers.required' => 'Please enter a group number for each schedule row.',
            'schedule_details.*.group_numbers.integer' => 'Group number must be a valid number.',
            'schedule_details.*.group_numbers.min' => 'Group number must be at least 1.',
